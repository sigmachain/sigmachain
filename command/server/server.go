...
import (
	...
	"github.com/sigmachain/sigmachain/command/server/config"
	"github.com/sigmachain/sigmachain/command/server/export"
...
func GetCommand() *cobra.Command {
	serverCmd := &cobra.Command{
		Use:     "server",
		Short:   "The default command that starts the SIGMA Network client, by bootstrapping all modules together",
		PreRunE: runPreRun,
		Run:     runCommand,
	}
...
func setFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringVar(
		...
		"the data directory used for storing SIGMA Network client data",
	)
