...
build:
	...
	go build -o sigmachain -ldflags="\
    	-X 'github.com/sigmachain/sigmachain/versioning.Version=$(LATEST_VERSION)' \
		-X 'github.com/sigmachain/sigmachain/versioning.Commit=$(COMMIT_HASH)'\
		-X 'github.com/sigmachain/sigmachain/versioning.Branch=$(BRANCH)'\
		-X 'github.com/sigmachain/sigmachain/versioning.BuildTime=$(TIME)'" \
	main.go
...
test-e2e:
	...
	go build -race -o artifacts/sigmachain .
	env EDGE_BINARY=${PWD}/artifacts/sigmachain go test -v -timeout=30m ./e2e/...
